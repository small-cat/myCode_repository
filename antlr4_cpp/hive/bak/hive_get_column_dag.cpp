...
void HiveGetColumnDagListener::enterSelect_list_item_asterisk(HqlsqlParser::Select_list_item_asteriskContext* ctx) {
 ...
 * @date 01/12/2019 
***********************************************************/ 
void HiveGetColumnDagListener::enterFullselect_set_clause(HqlsqlParser::Fullselect_set_clauseContext* ctx) {
