...
java -Xmx500M -cp /home/jona/software/antlr4/antlr-4.7.1-complete.jar org.antlr.v4.Tool -Dlanguage=Cpp -listener -visitor -o generated/ Db2SqlLexer.g4 Db2SqlParser.g4

sed -i 's/;;/;/g' generated/Db2SqlParser.h
