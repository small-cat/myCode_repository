...
java -Xmx500M -cp /home/jona/software/antlr4/antlr-4.7.1-complete.jar org.antlr.v4.Tool -Dlanguage=Cpp -long-messages -listener -visitor -o generated/ SqlXmlParser.g4 SqlXmlLexer.g4

sed -i 's/;;/;/g' generated/SqlXmlParser.h
