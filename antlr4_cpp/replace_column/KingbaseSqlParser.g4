...
concatenation
    : model_expression
        (AT (LOCAL | TIME ZONE concatenation) | interval_expression)?   # concat_model_expr
    | concatenation op=(ASTERISK | SOLIDUS) concatenation               # concat_mul_div
    | concatenation op=(PLUS_SIGN | MINUS_SIGN) concatenation           # concat_plus_minus
    | concatenation BAR BAR concatenation                               # concat_bar_bar
    ;
...
unary_expression
    : op=(MINUS_SIGN | PLUS_SIGN) unary_expression
