...
public:
  ...
  virtual void enterSelected_list_element_asterisk(KingbaseSqlParser::Selected_list_element_asteriskContext *ctx) = 0;
  virtual void exitSelected_list_element_asterisk(KingbaseSqlParser::Selected_list_element_asteriskContext *ctx) = 0;

  virtual void enterSelected_list_element_column(KingbaseSqlParser::Selected_list_element_columnContext *ctx) = 0;
  virtual void exitSelected_list_element_column(KingbaseSqlParser::Selected_list_element_columnContext *ctx) = 0;
  ...
  virtual void enterLock_table_statement(KingbaseSqlParser::Lock_table_statementContext *ctx) = 0;
  virtual void exitLock_table_statement(KingbaseSqlParser::Lock_table_statementContext *ctx) = 0;

  virtual void enterWait_nowait_part(KingbaseSqlParser::Wait_nowait_partContext *ctx) = 0;
  virtual void exitWait_nowait_part(KingbaseSqlParser::Wait_nowait_partContext *ctx) = 0;
  ...
  virtual void enterLock_table_element(KingbaseSqlParser::Lock_table_elementContext *ctx) = 0;
  virtual void exitLock_table_element(KingbaseSqlParser::Lock_table_elementContext *ctx) = 0;
  ...
  virtual void enterConcat_bar_bar(KingbaseSqlParser::Concat_bar_barContext *ctx) = 0;
  virtual void exitConcat_bar_bar(KingbaseSqlParser::Concat_bar_barContext *ctx) = 0;

  virtual void enterConcat_plus_minus(KingbaseSqlParser::Concat_plus_minusContext *ctx) = 0;
  virtual void exitConcat_plus_minus(KingbaseSqlParser::Concat_plus_minusContext *ctx) = 0;

  virtual void enterConcat_mul_div(KingbaseSqlParser::Concat_mul_divContext *ctx) = 0;
  virtual void exitConcat_mul_div(KingbaseSqlParser::Concat_mul_divContext *ctx) = 0;

  virtual void enterConcat_model_expr(KingbaseSqlParser::Concat_model_exprContext *ctx) = 0;
  virtual void exitConcat_model_expr(KingbaseSqlParser::Concat_model_exprContext *ctx) = 0;
  ...
  virtual void enterWindow_clause(KingbaseSqlParser::Window_clauseContext *ctx) = 0;
  virtual void exitWindow_clause(KingbaseSqlParser::Window_clauseContext *ctx) = 0;

  virtual void enterWindow_part(KingbaseSqlParser::Window_partContext *ctx) = 0;
  virtual void exitWindow_part(KingbaseSqlParser::Window_partContext *ctx) = 0;

  virtual void enterWindow_definition(KingbaseSqlParser::Window_definitionContext *ctx) = 0;
  virtual void exitWindow_definition(KingbaseSqlParser::Window_definitionContext *ctx) = 0;

  virtual void enterFrame_clause(KingbaseSqlParser::Frame_clauseContext *ctx) = 0;
  virtual void exitFrame_clause(KingbaseSqlParser::Frame_clauseContext *ctx) = 0;

  virtual void enterFrame_part(KingbaseSqlParser::Frame_partContext *ctx) = 0;
  virtual void exitFrame_part(KingbaseSqlParser::Frame_partContext *ctx) = 0;

  virtual void enterFrame_start_or_end(KingbaseSqlParser::Frame_start_or_endContext *ctx) = 0;
  virtual void exitFrame_start_or_end(KingbaseSqlParser::Frame_start_or_endContext *ctx) = 0;
  ...
  virtual void enterCost_matrix_clause(KingbaseSqlParser::Cost_matrix_clauseContext *ctx) = 0;
  virtual void exitCost_matrix_clause(KingbaseSqlParser::Cost_matrix_clauseContext *ctx) = 0;
