...
class  KingbaseSqlParser : public KingbaseSqlBaseParser {
public:
  enum {
  ...
  enum {
    RuleSql_script = 0, RuleUnit_sql_statement = 1, RuleUnit_statement = 2, 
    RuleAlter_full_search_configuration = 3, RuleToken_or_dictionary = 4, 
    RuleAlter_full_search_dictionary = 5, RuleAlter_full_search_parser = 6, 
    RuleAlter_full_search_template = 7, RuleDrop_full_search = 8, RuleDrop_index_schema_sequence_table_view = 9, 
    RuleDrop_materialize_view = 10, RuleDrop_synonym = 11, RuleDrop_tablespace = 12, 
    RuleDrop_directory = 13, RuleAlter_function = 14, RuleDrop_function = 15, 
    RuleCreate_function_statement = 16, RuleSequence_of_statements = 17, 
    RuleSequence_of_statement = 18, RuleCreate_package = 19, RuleAlter_package = 20, 
    RuleDrop_package = 21, RulePackage_names = 22, RulePackage_name = 23, 
    RulePackage_body = 24, RuleInitialization_statement = 25, RuleProcedure_definition = 26, 
    RuleFunction_definition = 27, RuleDrop_procedure = 28, RuleAlter_procedure = 29, 
    RuleCreate_procedure_statement = 30, RulePlsql_block = 31, RuleDeclare_statement = 32, 
    RuleDrop_trigger = 33, RuleAlter_trigger = 34, RuleCreate_trigger = 35, 
    RuleExecute_procedure_statement = 36, RuleDml_event_clause = 37, RuleDml_event_element = 38, 
    RuleDrop_type = 39, RuleCreate_type = 40, RuleType_options = 41, RuleType_elements_parameter = 42, 
    RuleDrop_sequence = 43, RuleAlter_sequence = 44, RuleAlter_synonym = 45, 
    RuleAlter_system = 46, RuleSystem_spec = 47, RuleCreate_sequence = 48, 
    RuleSequence_spec = 49, RuleCreate_index = 50, RuleCreate_full_index = 51, 
    RuleIndex_expr = 52, RuleIndextype = 53, RuleAlter_index = 54, RuleAlter_schema = 55, 
    RuleNew_partition_name = 56, RuleCreate_user = 57, RuleCreate_role = 58, 
    RuleAlter_user = 59, RuleAlter_role = 60, RuleDrop_role = 61, RuleDrop_user = 62, 
    RuleDrop_owned = 63, RuleReassign_owned = 64, RuleEnable_user_ip = 65, 
    RuleIdentified_by = 66, RuleIdentified_other_clause = 67, RuleUser_tablespace_clause = 68, 
    RuleProfile_clause = 69, RuleAnalyze = 70, RuleCheckpoint = 71, RuleCluster = 72, 
    RuleComment = 73, RuleComment_spec = 74, RuleCopy_datafile = 75, RuleCreate_database = 76, 
    RuleCreate_full_search_configuration = 77, RuleCreate_full_search_dictionary = 78, 
    RuleCreate_full_search_parser = 79, RuleCreate_full_search_template = 80, 
    RuleDrop_index = 81, RuleGrant_statement = 82, RuleGrant_object_privilege = 83, 
    RuleGrant_column_privilege = 84, RuleGrant_role_privilege = 85, RuleRevoke_statement = 86, 
    RuleRevoke_object_privilege = 87, RuleRevoke_role_privilege = 88, RuleCreate_directory = 89, 
    RuleDirectory_name = 90, RuleDirectory_path = 91, RuleDbcc_checkallocate = 92, 
    RuleDbcc_checkcatalog = 93, RuleDbcc_checktable = 94, RuleDbcc_checkindex = 95, 
    RuleDbcc_checktablespace = 96, RuleDbcc_checkdb = 97, RuleCreate_view = 98, 
    RuleCreate_rule = 99, RuleRulename = 100, RuleEvent = 101, RuleCreate_force_view = 102, 
    RuleAlter_tablespace = 103, RuleTablespace_state_clauses = 104, RuleNew_tablespace_name = 105, 
    RuleCreate_tablespace = 106, RuleTablespace_retention_clause = 107, 
    RuleBuild_clause = 108, RuleAlter_materialized_view = 109, RuleInterval_expr = 110, 
    RuleCreate_materialized_view = 111, RuleCreate_schema = 112, RuleCreate_table = 113, 
    RuleCreate_table_without_select = 114, RuleCreate_table_as_select = 115, 
    RuleCreate_table_select_into = 116, RuleColumn_with_datatype_list = 117, 
    RuleColumn_with_datatype = 118, RuleColumn_constraint = 119, RuleTable_constraint = 120, 
    RuleAction = 121, RuleSubpartition_name = 122, RuleDrop_table = 123, 
    RuleAllow_or_disallow = 124, RuleCreate_synonym = 125, RuleComment_on_table = 126, 
    RuleDatabase_name = 127, RuleAlter_database = 128, RuleAlter_table = 129, 
    RuleAlter_table_add_properties = 130, RuleAlter_table_change_properties = 131, 
    RuleAlter_table_drop_properties = 132, RuleAlter_table_rename_properties = 133, 
    RuleAlter_table_truncate_properties = 134, RuleAlter_table_others = 135, 
    RuleTablespace = 136, RulePartition_name = 137, RuleColumn_or_attribute = 138, 
    RuleParameter = 139, RuleDefault_value_part = 140, RuleParameter_list = 141, 
    RuleParen_parameter_list = 142, RuleVariable_declaration = 143, RuleVariable_declarations = 144, 
    RuleCursor_declaration = 145, RuleCursor_declarations = 146, RuleParameter_spec = 147, 
    RuleRecord_type_def = 148, RuleField_spec = 149, RuleRef_cursor_type_def = 150, 
    RuleType_declaration = 151, RuleTable_type_def = 152, RuleTable_indexed_by_part = 153, 
    RuleVarray_type_def = 154, RuleSeq_of_statements = 155, RuleLabel_declaration = 156, 
    RuleStatement = 157, RuleAssignment_statement = 158, RuleContinue_statement = 159, 
    RuleExit_statement = 160, RuleGoto_statement = 161, RuleIf_statement = 162, 
    RuleElsif_part = 163, RuleElse_part = 164, RuleLoop_statement = 165, 
    RuleCursor_loop_param = 166, RuleForall_statement = 167, RuleBounds_clause = 168, 
    RuleBetween_bound = 169, RuleLower_bound = 170, RuleUpper_bound = 171, 
    RuleNull_statement = 172, RuleRaise_statement = 173, RuleReturn_statement = 174, 
    RuleFunction_call = 175, RuleProcedure_call = 176, RulePipe_row_statement = 177, 
    RuleSql_statement = 178, RuleData_manipulation_language_statements = 179, 
    RuleCursor_manipulation_statements = 180, RuleClose_statement = 181, 
    RuleOpen_statement = 182, RuleFetch_statement = 183, RuleDirection = 184, 
    RuleCount = 185, RuleMove_statement = 186, RuleTransaction_control_statements = 187, 
    RuleTransaction_command = 188, RuleLock_mode = 189, RuleSavepoint_command = 190, 
    RuleExplain_statement = 191, RuleExplain_elements = 192, RuleExplain_element = 193, 
    RuleSelect_statement = 194, RuleWith_clause = 195, RuleWith_query = 196, 
    RuleSubquery = 197, RuleSubquery_basic_elements = 198, RuleSubquery_operation_part = 199, 
    RuleQuery_block = 200, RuleTop_clause = 201, RuleStart_value = 202, 
    RuleLine_count = 203, RuleSelected_list = 204, RuleSelected_list_element = 205, 
    RuleFrom_clause = 206, RuleTable_ref_list = 207, RuleTable_ref = 208, 
    RuleTable_ref_aux = 209, RuleTable_ref_aux_internal = 210, RuleJoin_clause = 211, 
    RuleJoin_on_part = 212, RuleJoin_using_part = 213, RuleOuter_join_type = 214, 
    RuleQuery_partition_clause = 215, RulePivot_clause = 216, RulePivot_element = 217, 
    RulePivot_for_clause = 218, RulePivot_in_clause = 219, RulePivot_in_clause_element = 220, 
    RulePivot_in_clause_elements = 221, RuleUnpivot_clause = 222, RuleUnpivot_in_clause = 223, 
    RuleUnpivot_in_elements = 224, RuleHierarchical_query_clause = 225, 
    RuleStart_part = 226, RuleGroup_by_clause = 227, RuleGroup_by_elements = 228, 
    RuleRollup_cube_expression = 229, RuleEmpty_expression = 230, RuleGrouping_sets_expression = 231, 
    RuleHaving_clause = 232, RuleCell_assignment = 233, RuleUntil_part = 234, 
    RuleOrder_by_clause = 235, RuleOrder_by_elements = 236, RuleLimit_clause = 237, 
    RuleOffset_clause = 238, RuleFetch_clause = 239, RuleFor_update_clause = 240, 
    RuleFor_update_of_part = 241, RuleFor_update_options = 242, RuleUpdate_statement = 243, 
    RuleUpdate_set_clause = 244, RuleColumn_based_update_set_clause = 245, 
    RuleDelete_statement = 246, RuleInsert_statement = 247, RuleSingle_table_insert = 248, 
    RuleMulti_table_insert = 249, RuleMulti_table_element = 250, RuleConditional_insert_clause = 251, 
    RuleConditional_insert_when_part = 252, RuleConditional_insert_else_part = 253, 
    RuleInsert_into_clause = 254, RuleValues_clause = 255, RuleCopy_statement = 256, 
    RuleMerge_statement = 257, RuleMerge_update_clause = 258, RuleMerge_element = 259, 
    RuleMerge_update_delete_part = 260, RuleMerge_insert_clause = 261, RuleSelected_tableview = 262, 
    RuleLock_table_statement = 263, RuleWait_nowait_part = 264, RuleTruncate_statement = 265, 
    RuleLock_table_element = 266, RuleGeneral_table_ref = 267, RuleStatic_returning_clause = 268, 
    RuleError_logging_into_part = 269, RuleError_logging_reject_part = 270, 
    RuleDml_table_expression_clause = 271, RuleTable_collection_expression = 272, 
    RuleSubquery_restriction_clause = 273, RuleSample_clause = 274, RuleSeed_part = 275, 
    RuleCondition = 276, RuleExpressions = 277, RuleExpression = 278, RuleCursor_expression = 279, 
    RuleLogical_expression = 280, RuleMultiset_expression = 281, RuleRelational_expression = 282, 
    RuleCompound_expression = 283, RuleRelational_operator = 284, RuleIn_elements = 285, 
    RuleBetween_elements = 286, RuleConcatenation = 287, RuleInterval_expression = 288, 
    RuleModel_expression = 289, RuleModel_expression_element = 290, RuleSingle_column_for_loop = 291, 
    RuleMulti_column_for_loop = 292, RuleUnary_expression = 293, RuleCase_statement = 294, 
    RuleSimple_case_statement = 295, RuleSimple_case_when_part = 296, RuleSearched_case_statement = 297, 
    RuleSearched_case_when_part = 298, RuleCase_else_part = 299, RuleAtom = 300, 
    RuleQuantified_expression = 301, RuleString_function = 302, RuleStandard_function = 303, 
    RuleNumeric_function_wrapper = 304, RuleNumeric_function = 305, RuleOther_function = 306, 
    RuleOver_clause_keyword = 307, RuleWithin_or_over_clause_keyword = 308, 
    RuleStandard_prediction_function_keyword = 309, RuleOver_clause = 310, 
    RuleWindow_clause = 311, RuleWindow_part = 312, RuleWindow_definition = 313, 
    RuleFrame_clause = 314, RuleFrame_part = 315, RuleFrame_start_or_end = 316, 
    RuleCollect_order_by_part = 317, RuleWithin_or_over_part = 318, RuleCost_matrix_clause = 319, 
    RuleXml_passing_clause = 320, RuleXml_attributes_clause = 321, RuleXml_namespaces_clause = 322, 
    RuleXml_table_column = 323, RuleXml_general_default_part = 324, RuleXml_multiuse_expression_element = 325, 
    RuleXmlroot_param_version_part = 326, RuleXmlroot_param_standalone_part = 327, 
    RuleXmlserialize_param_enconding_part = 328, RuleXmlserialize_param_version_part = 329, 
    RuleXmlserialize_param_ident_part = 330, RuleSql_plus_command = 331, 
    RuleGet_arguments_command = 332, RuleSet_arguments_command = 333, RulePartition_extension_clause = 334, 
    RuleColumn_alias = 335, RuleTable_alias = 336, RuleWhere_clause = 337, 
    RuleXml_column_name = 338, RuleCost_class_name = 339, RuleSavepoint_name = 340, 
    RuleRollback_segment_name = 341, RuleTable_var_name = 342, RuleSchema_name = 343, 
    RuleRoutine_name = 344, RuleImplementation_type_name = 345, RuleParameter_name = 346, 
    RuleReference_model_name = 347, RuleMain_model_name = 348, RuleContainer_tableview_name = 349, 
    RuleAggregate_function_name = 350, RuleWith_query_name = 351, RuleGrantee_name = 352, 
    RuleRole_name = 353, RuleConstraint_name = 354, RuleLabel_name = 355, 
    RuleType_name = 356, RuleSequence_name = 357, RuleException_name = 358, 
    RuleFunction_name = 359, RuleProcedure_name = 360, RuleTrigger_name = 361, 
    RuleVariable_name = 362, RuleIndex_name = 363, RuleCursor_name = 364, 
    RuleRecord_name = 365, RuleCollection_name = 366, RuleLink_name = 367, 
    RuleColumn_name = 368, RuleTableview_name = 369, RuleTable_name = 370, 
    RuleChar_set_name = 371, RuleSynonym_name = 372, RuleSchema_object_name = 373, 
    RuleDir_object_name = 374, RuleUser_object_name = 375, RuleGrant_object_name = 376, 
    RuleColumn_list = 377, RuleParen_column_list = 378, RuleTablename_list = 379, 
    RuleKeep_clause = 380, RuleFunction_argument = 381, RuleFunction_argument_analytic = 382, 
    RuleFunction_argument_modeling = 383, RuleRespect_or_ignore_nulls = 384, 
    RuleArgument = 385, RuleDatatype = 386, RulePrecision_part = 387, RuleNative_datatype_element = 388, 
    RuleBind_variable = 389, RuleGeneral_element = 390, RuleGeneral_element_part = 391, 
    RuleTable_element = 392, RuleObject_privilege = 393, RuleColumn_privilege = 394, 
    RuleSystem_privilege = 395, RuleConstant = 396, RuleNumeric = 397, RuleNumeric_negative = 398, 
    RuleQuoted_string = 399, RuleIdentifier = 400, RuleId_expression = 401, 
    RuleOuter_join_sign = 402, RuleRegular_id = 403, RuleNon_reserved_keywords_in_12c = 404, 
    RuleNon_reserved_keywords_pre12c = 405
  };

  KingbaseSqlParser(antlr4::TokenStream *input);
  ~KingbaseSqlParser();
  ...
  class Unit_sql_statementContext;
  class Unit_statementContext;
  class Alter_full_search_configurationContext;
  class Token_or_dictionaryContext;
  class Alter_full_search_dictionaryContext;
  class Alter_full_search_parserContext;
  class Alter_full_search_templateContext;
  class Drop_full_searchContext;
  class Drop_index_schema_sequence_table_viewContext;
  class Drop_materialize_viewContext;
  ...
  class Package_namesContext;
  class Package_nameContext;
  class Package_bodyContext;
  class Initialization_statementContext;
  class Procedure_definitionContext;
  ...
  class Drop_ownedContext;
  class Reassign_ownedContext;
  class Enable_user_ipContext;
  ...
  class Comment_specContext;
  class Copy_datafileContext;
  class Create_databaseContext;
  class Create_full_search_configurationContext;
  class Create_full_search_dictionaryContext;
  class Create_full_search_parserContext;
  class Create_full_search_templateContext;
  class Drop_indexContext;
  class Grant_statementContext;
  class Grant_object_privilegeContext;
  class Grant_column_privilegeContext;
  class Grant_role_privilegeContext;
  class Revoke_statementContext;
  class Revoke_object_privilegeContext;
  class Revoke_role_privilegeContext;
  class Create_directoryContext;
  class Directory_nameContext;
  class Directory_pathContext;
  class Dbcc_checkallocateContext;
  class Dbcc_checkcatalogContext;
  class Dbcc_checktableContext;
  class Dbcc_checkindexContext;
  class Dbcc_checktablespaceContext;
  class Dbcc_checkdbContext;
  class Create_viewContext;
  class Create_ruleContext;
  class RulenameContext;
  class EventContext;
  class Create_force_viewContext;
  ...
  class Create_table_without_selectContext;
  class Create_table_as_selectContext;
  class Create_table_select_intoContext;
  class Column_with_datatype_listContext;
  class Column_with_datatypeContext;
  ...
  class Alter_table_add_propertiesContext;
  class Alter_table_change_propertiesContext;
  class Alter_table_drop_propertiesContext;
  class Alter_table_rename_propertiesContext;
  class Alter_table_truncate_propertiesContext;
  class Alter_table_othersContext;
  ...
  class CountContext;
  class Move_statementContext;
  class Transaction_control_statementsContext;
  class Transaction_commandContext;
  class Lock_modeContext;
  class Savepoint_commandContext;
  class Explain_statementContext;
  class Explain_elementsContext;
  class Explain_elementContext;
  ...
  class Window_partContext;
  class Window_definitionContext;
  class Frame_clauseContext;
  class Frame_partContext;
  class Frame_start_or_endContext;
  ...
  class Get_arguments_commandContext;
  class Set_arguments_commandContext;
  ...
  public:
    ...
    std::vector<Unit_sql_statementContext *> unit_sql_statement();
    Unit_sql_statementContext* unit_sql_statement(size_t i);
  ...
  class  Unit_sql_statementContext : public antlr4::ParserRuleContext {
  public:
    Unit_sql_statementContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  Unit_sql_statementContext* unit_sql_statement();
  ...
  public:
    ...
    Alter_full_search_configurationContext *alter_full_search_configuration();
    Alter_full_search_dictionaryContext *alter_full_search_dictionary();
    Alter_full_search_parserContext *alter_full_search_parser();
    Alter_full_search_templateContext *alter_full_search_template();
    ...
    Alter_systemContext *alter_system();
    ...
    Copy_datafileContext *copy_datafile();
    Create_databaseContext *create_database();
    Create_full_search_configurationContext *create_full_search_configuration();
    Create_full_search_dictionaryContext *create_full_search_dictionary();
    Create_full_search_parserContext *create_full_search_parser();
    Create_full_search_templateContext *create_full_search_template();
    Create_indexContext *create_index();
    Create_full_indexContext *create_full_index();
    ...
    Create_force_viewContext *create_force_view();
    Create_directoryContext *create_directory();
    Dbcc_checkallocateContext *dbcc_checkallocate();
    Dbcc_checkcatalogContext *dbcc_checkcatalog();
    Dbcc_checktableContext *dbcc_checktable();
    Dbcc_checkindexContext *dbcc_checkindex();
    Dbcc_checktablespaceContext *dbcc_checktablespace();
    Dbcc_checkdbContext *dbcc_checkdb();
    Drop_full_searchContext *drop_full_search();
    Drop_index_schema_sequence_table_viewContext *drop_index_schema_sequence_table_view();
    Drop_materialize_viewContext *drop_materialize_view();
    ...
    Drop_ownedContext *drop_owned();
    Reassign_ownedContext *reassign_owned();
    Grant_statementContext *grant_statement();
    Revoke_statementContext *revoke_statement();
    Enable_user_ipContext *enable_user_ip();
  ...
  class  Alter_full_search_configurationContext : public antlr4::ParserRuleContext {
  public:
    Alter_full_search_configurationContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    ...
    std::vector<Token_or_dictionaryContext *> token_or_dictionary();
    Token_or_dictionaryContext* token_or_dictionary(size_t i);
  ...
  class  Token_or_dictionaryContext : public antlr4::ParserRuleContext {
  public:
    Token_or_dictionaryContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  Token_or_dictionaryContext* token_or_dictionary();

  class  Alter_full_search_dictionaryContext : public antlr4::ParserRuleContext {
  public:
    Alter_full_search_dictionaryContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  Alter_full_search_parserContext : public antlr4::ParserRuleContext {
  public:
    Alter_full_search_parserContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *ALTER();
    antlr4::tree::TerminalNode *FULLTEXT();
    antlr4::tree::TerminalNode *SEARCH();
  ...
  class  Alter_full_search_templateContext : public antlr4::ParserRuleContext {
  public:
    Alter_full_search_templateContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *ALTER();
    antlr4::tree::TerminalNode *FULLTEXT();
    antlr4::tree::TerminalNode *SEARCH();
  ...
  class  Drop_full_searchContext : public antlr4::ParserRuleContext {
  public:
    Drop_full_searchContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *DROP();
    antlr4::tree::TerminalNode *FULLTEXT();
    antlr4::tree::TerminalNode *SEARCH();
  ...
  class  Drop_index_schema_sequence_table_viewContext : public antlr4::ParserRuleContext {
  public:
    Drop_index_schema_sequence_table_viewContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *DROP();
  ...
  class  Drop_materialize_viewContext : public antlr4::ParserRuleContext {
  public:
    Drop_materialize_viewContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *DROP();
  ...
  public:
    ...
    Paren_parameter_listContext *paren_parameter_list();
  ...
  public:
    ...
    Plsql_blockContext *plsql_block();
  ...
  public:
    ...
    Initialization_statementContext *initialization_statement();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *DROP();
    antlr4::tree::TerminalNode *PACKAGE();
    Package_namesContext *package_names();
    antlr4::tree::TerminalNode *SEMICOLON();
    antlr4::tree::TerminalNode *BODY();
    antlr4::tree::TerminalNode *IF();
    antlr4::tree::TerminalNode *EXISTS();
  ...
  class  Package_namesContext : public antlr4::ParserRuleContext {
  public:
    Package_namesContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<Package_nameContext *> package_name();
    Package_nameContext* package_name(size_t i);
    std::vector<antlr4::tree::TerminalNode *> COMMA();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    Procedure_definitionContext *procedure_definition();
  ...
  class  Initialization_statementContext : public antlr4::ParserRuleContext {
  public:
    Initialization_statementContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    Plsql_blockContext *plsql_block();
  ...
  class  Procedure_definitionContext : public antlr4::ParserRuleContext {
  public:
    Procedure_definitionContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  public:
    ...
    antlr4::tree::TerminalNode *ALTER();
    antlr4::tree::TerminalNode *PROCEDURE();
    std::vector<Procedure_nameContext *> procedure_name();
    Procedure_nameContext* procedure_name(size_t i);
    antlr4::tree::TerminalNode *SEMICOLON();
    antlr4::tree::TerminalNode *RENAME();
    antlr4::tree::TerminalNode *TO();
    antlr4::tree::TerminalNode *COMPILE();
  ...
  public:
    ...
    Cursor_declarationsContext *cursor_declarations();
    antlr4::tree::TerminalNode *DEFINER();
    antlr4::tree::TerminalNode *INVOKER();
  ...
  class  Plsql_blockContext : public antlr4::ParserRuleContext {
  public:
    Plsql_blockContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *BEGIN();
    Sequence_of_statementsContext *sequence_of_statements();
    antlr4::tree::TerminalNode *END();
  ...
  public:
    ...
    Execute_procedure_statementContext *execute_procedure_statement();
    Plsql_blockContext *plsql_block();
    antlr4::tree::TerminalNode *OR();
    antlr4::tree::TerminalNode *REPLACE();
    antlr4::tree::TerminalNode *AS();
  ...
  class  Execute_procedure_statementContext : public antlr4::ParserRuleContext {
  public:
    Execute_procedure_statementContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  public:
    ...
    Type_nameContext *type_name();
    antlr4::tree::TerminalNode *LEFT_PAREN();
    Type_optionsContext *type_options();
    antlr4::tree::TerminalNode *RIGHT_PAREN();
    antlr4::tree::TerminalNode *SEMICOLON();
  ...
  class  Type_optionsContext : public antlr4::ParserRuleContext {
  public:
    Type_optionsContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    ...
    antlr4::tree::TerminalNode *PASSEDBYVALUE();
  ...
  class  Alter_systemContext : public antlr4::ParserRuleContext {
  public:
    Alter_systemContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *ALTER();
    antlr4::tree::TerminalNode *SYSTEM();
    System_specContext *system_spec();
  ...
  class  System_specContext : public antlr4::ParserRuleContext {
  public:
    System_specContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *ADD();
    antlr4::tree::TerminalNode *LEFT_PAREN();
  ...
  class  Create_full_indexContext : public antlr4::ParserRuleContext {
  public:
    Create_full_indexContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *CREATE();
    antlr4::tree::TerminalNode *FULLTEXT();
    antlr4::tree::TerminalNode *INDEX();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *SUPERUSER();
    antlr4::tree::TerminalNode *SSO();
    antlr4::tree::TerminalNode *SAO();
  ...
  class  Drop_ownedContext : public antlr4::ParserRuleContext {
  public:
    Drop_ownedContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *DROP();
  ...
  class  Reassign_ownedContext : public antlr4::ParserRuleContext {
  public:
    Reassign_ownedContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  Enable_user_ipContext : public antlr4::ParserRuleContext {
  public:
    Enable_user_ipContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *ENABLE();
    ExpressionContext *expression();
    antlr4::tree::TerminalNode *USER();
  ...
  class  CheckpointContext : public antlr4::ParserRuleContext {
  public:
    CheckpointContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  ClusterContext : public antlr4::ParserRuleContext {
  public:
    ClusterContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  public:
    ...
    antlr4::tree::TerminalNode *ON();
    Comment_specContext *comment_spec();
    antlr4::tree::TerminalNode *IS();
    antlr4::tree::TerminalNode *CHAR_STRING();
  ...
  class  Comment_specContext : public antlr4::ParserRuleContext {
  public:
    Comment_specContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *TABLE();
    Tableview_nameContext *tableview_name();
  ...
  class  Copy_datafileContext : public antlr4::ParserRuleContext {
  public:
    Copy_datafileContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  Create_full_search_configurationContext : public antlr4::ParserRuleContext {
  public:
    Create_full_search_configurationContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *CREATE();
    antlr4::tree::TerminalNode *FULLTEXT();
    antlr4::tree::TerminalNode *SEARCH();
  ...
  class  Create_full_search_dictionaryContext : public antlr4::ParserRuleContext {
  public:
    Create_full_search_dictionaryContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *CREATE();
    antlr4::tree::TerminalNode *FULLTEXT();
    antlr4::tree::TerminalNode *SEARCH();
  ...
  class  Create_full_search_parserContext : public antlr4::ParserRuleContext {
  public:
    Create_full_search_parserContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *CREATE();
    antlr4::tree::TerminalNode *FULLTEXT();
    antlr4::tree::TerminalNode *SEARCH();
  ...
  class  Create_full_search_templateContext : public antlr4::ParserRuleContext {
  public:
    Create_full_search_templateContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *CREATE();
    antlr4::tree::TerminalNode *FULLTEXT();
    antlr4::tree::TerminalNode *SEARCH();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    Grant_object_privilegeContext *grant_object_privilege();
    Grant_column_privilegeContext *grant_column_privilege();
    Grant_role_privilegeContext *grant_role_privilege();
  ...
  class  Grant_object_privilegeContext : public antlr4::ParserRuleContext {
  public:
    Grant_object_privilegeContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  Grant_column_privilegeContext : public antlr4::ParserRuleContext {
  public:
    Grant_column_privilegeContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<antlr4::tree::TerminalNode *> GRANT();
    antlr4::tree::TerminalNode* GRANT(size_t i);
    antlr4::tree::TerminalNode *ON();
    Tablename_listContext *tablename_list();
    antlr4::tree::TerminalNode *TO();
    Column_privilegeContext *column_privilege();
    Paren_column_listContext *paren_column_list();
    antlr4::tree::TerminalNode *ALL();
    IdentifierContext *identifier();
    antlr4::tree::TerminalNode *PUBLIC();
  ...
  class  Grant_role_privilegeContext : public antlr4::ParserRuleContext {
  public:
    Grant_role_privilegeContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<antlr4::tree::TerminalNode *> GRANT();
    antlr4::tree::TerminalNode* GRANT(size_t i);
    std::vector<IdentifierContext *> identifier();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    Revoke_object_privilegeContext *revoke_object_privilege();
    Revoke_role_privilegeContext *revoke_role_privilege();
  ...
  class  Revoke_object_privilegeContext : public antlr4::ParserRuleContext {
  public:
    Revoke_object_privilegeContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  Revoke_role_privilegeContext : public antlr4::ParserRuleContext {
  public:
    Revoke_role_privilegeContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *REVOKE();
    std::vector<IdentifierContext *> identifier();
    IdentifierContext* identifier(size_t i);
  ...
  class  Dbcc_checkallocateContext : public antlr4::ParserRuleContext {
  public:
    Dbcc_checkallocateContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *DBCC();
    antlr4::tree::TerminalNode *CHECKALLOCATE();
  ...
  public:
    ...
    antlr4::tree::TerminalNode *NOALLOCATE();
  ...
  class  Dbcc_checkindexContext : public antlr4::ParserRuleContext {
  public:
    Dbcc_checkindexContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *DBCC();
    antlr4::tree::TerminalNode *CHECKINDEX();
    Tableview_nameContext *tableview_name();
    antlr4::tree::TerminalNode *VERBOSE();
  ...
  class  Dbcc_checktablespaceContext : public antlr4::ParserRuleContext {
  public:
    Dbcc_checktablespaceContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *DBCC();
    antlr4::tree::TerminalNode *CHECKTABLESPACE();
    Tableview_nameContext *tableview_name();
    antlr4::tree::TerminalNode *VERBOSE();
    antlr4::tree::TerminalNode *WITH();
    antlr4::tree::TerminalNode *NOINDEX();
    std::vector<antlr4::tree::TerminalNode *> COMMA();
    antlr4::tree::TerminalNode* COMMA(size_t i);
    antlr4::tree::TerminalNode *NOCONSTRAINT();
    antlr4::tree::TerminalNode *NOALLOCATE();
  ...
  class  Create_force_viewContext : public antlr4::ParserRuleContext {
  public:
    Create_force_viewContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *CREATE();
    antlr4::tree::TerminalNode *VIEW();
    Tableview_nameContext *tableview_name();
  ...
  public:
    ...
    std::vector<antlr4::tree::TerminalNode *> FILEGROWTH();
    antlr4::tree::TerminalNode* FILEGROWTH(size_t i);
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    Create_table_without_selectContext *create_table_without_select();
    Create_table_as_selectContext *create_table_as_select();
    Create_table_select_intoContext *create_table_select_into();
  ...
  class  Create_table_without_selectContext : public antlr4::ParserRuleContext {
  public:
    Create_table_without_selectContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *CREATE();
    antlr4::tree::TerminalNode *TABLE();
    Tableview_nameContext *tableview_name();
    Column_with_datatype_listContext *column_with_datatype_list();
    antlr4::tree::TerminalNode *WITHOUT();
  ...
  class  Create_table_as_selectContext : public antlr4::ParserRuleContext {
  public:
    Create_table_as_selectContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *CREATE();
    antlr4::tree::TerminalNode *TABLE();
    Tableview_nameContext *tableview_name();
  ...
  class  Create_table_select_intoContext : public antlr4::ParserRuleContext {
  public:
    Create_table_select_intoContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *SELECT();
  ...
  class  Column_with_datatype_listContext : public antlr4::ParserRuleContext {
  public:
    Column_with_datatype_listContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *LEFT_PAREN();
    std::vector<Column_with_datatypeContext *> column_with_datatype();
    Column_with_datatypeContext* column_with_datatype(size_t i);
    antlr4::tree::TerminalNode *RIGHT_PAREN();
    std::vector<antlr4::tree::TerminalNode *> COMMA();
    antlr4::tree::TerminalNode* COMMA(size_t i);
  ...
  class  Column_with_datatypeContext : public antlr4::ParserRuleContext {
  public:
    Column_with_datatypeContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    Column_nameContext *column_name();
    DatatypeContext *datatype();
    antlr4::tree::TerminalNode *ENCRYPTED();
  ...
  Column_with_datatypeContext* column_with_datatype();
  ...
  public:
    KingbaseSqlParser::ExpressionContext *option = nullptr;;
  ...
  public:
    ...
    Tableview_nameContext *tableview_name();
    antlr4::tree::TerminalNode *SEMICOLON();
    Alter_table_add_propertiesContext *alter_table_add_properties();
    Alter_table_change_propertiesContext *alter_table_change_properties();
    Alter_table_drop_propertiesContext *alter_table_drop_properties();
    Alter_table_rename_propertiesContext *alter_table_rename_properties();
    Alter_table_truncate_propertiesContext *alter_table_truncate_properties();
    Alter_table_othersContext *alter_table_others();
  ...
  class  Alter_table_add_propertiesContext : public antlr4::ParserRuleContext {
  public:
    Alter_table_add_propertiesContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *ADD();
    Column_nameContext *column_name();
    DatatypeContext *datatype();
  ...
  class  Alter_table_change_propertiesContext : public antlr4::ParserRuleContext {
  public:
    Alter_table_change_propertiesContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *ALTER();
    Column_nameContext *column_name();
    antlr4::tree::TerminalNode *TYPE();
  ...
  class  Alter_table_drop_propertiesContext : public antlr4::ParserRuleContext {
  public:
    Alter_table_drop_propertiesContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *DROP();
    Column_nameContext *column_name();
    antlr4::tree::TerminalNode *COLUMN();
  ...
  class  Alter_table_rename_propertiesContext : public antlr4::ParserRuleContext {
  public:
    Alter_table_rename_propertiesContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *RENAME();
    Column_nameContext *column_name();
    antlr4::tree::TerminalNode *COLUMN();
  ...
  class  Alter_table_truncate_propertiesContext : public antlr4::ParserRuleContext {
  public:
    Alter_table_truncate_propertiesContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  Alter_table_othersContext : public antlr4::ParserRuleContext {
  public:
    Alter_table_othersContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *SET();
  ...
  class  Paren_parameter_listContext : public antlr4::ParserRuleContext {
  public:
    Paren_parameter_listContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *LEFT_PAREN();
    antlr4::tree::TerminalNode *RIGHT_PAREN();
    Parameter_listContext *parameter_list();
  ...
  class  Cursor_declarationsContext : public antlr4::ParserRuleContext {
  public:
    Cursor_declarationsContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<Cursor_declarationContext *> cursor_declaration();
    Cursor_declarationContext* cursor_declaration(size_t i);
    std::vector<antlr4::tree::TerminalNode *> SEMICOLON();
    antlr4::tree::TerminalNode* SEMICOLON(size_t i);
  ...
  public:
    ...
    Move_statementContext *move_statement();
  ...
  class  Move_statementContext : public antlr4::ParserRuleContext {
  public:
    Move_statementContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    Transaction_commandContext *transaction_command();
    Savepoint_commandContext *savepoint_command();
  ...
  class  Transaction_commandContext : public antlr4::ParserRuleContext {
  public:
    Transaction_commandContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *SET();
  ...
  class  Savepoint_commandContext : public antlr4::ParserRuleContext {
  public:
    Savepoint_commandContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  public:
    ...
    antlr4::tree::TerminalNode *VERBOSE();
    antlr4::tree::TerminalNode *LEFT_PAREN();
    Explain_elementsContext *explain_elements();
    antlr4::tree::TerminalNode *RIGHT_PAREN();
  ...
  class  Explain_elementsContext : public antlr4::ParserRuleContext {
  public:
    Explain_elementsContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<Explain_elementContext *> explain_element();
    Explain_elementContext* explain_element(size_t i);
    std::vector<antlr4::tree::TerminalNode *> COMMA();
    antlr4::tree::TerminalNode* COMMA(size_t i);
  ...
  class  Explain_elementContext : public antlr4::ParserRuleContext {
  public:
    Explain_elementContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    ExpressionContext *expression();
    antlr4::tree::TerminalNode *ANALYZE();
    antlr4::tree::TerminalNode *VERBOSE();
    antlr4::tree::TerminalNode *COSTS();
  ...
  Explain_elementContext* explain_element();
  ...
  public:
    ...
    Selected_list_elementContext() : antlr4::ParserRuleContext() { }
    void copyFrom(Selected_list_elementContext *context);
  ...
  class  Selected_list_element_columnContext : public Selected_list_elementContext {
  public:
    Selected_list_element_columnContext(Selected_list_elementContext *ctx);
  ...
  class  Selected_list_element_asteriskContext : public Selected_list_elementContext {
  public:
    Selected_list_element_asteriskContext(Selected_list_elementContext *ctx);
  ...
  public:
    ...
    std::vector<For_update_of_partContext *> for_update_of_part();
    For_update_of_partContext* for_update_of_part(size_t i);
    std::vector<For_update_optionsContext *> for_update_options();
    For_update_optionsContext* for_update_options(size_t i);
  ...
  public:
    ...
    ConcatenationContext() : antlr4::ParserRuleContext() { }
    void copyFrom(ConcatenationContext *context);
    using antlr4::ParserRuleContext::copyFrom;
  ...
  class  Concat_bar_barContext : public ConcatenationContext {
  public:
    Concat_bar_barContext(ConcatenationContext *ctx);
  ...
  class  Concat_plus_minusContext : public ConcatenationContext {
  public:
    Concat_plus_minusContext(ConcatenationContext *ctx);
  ...
  class  Concat_mul_divContext : public ConcatenationContext {
  public:
    Concat_mul_divContext(ConcatenationContext *ctx);
  ...
  class  Concat_model_exprContext : public ConcatenationContext {
  public:
    Concat_model_exprContext(ConcatenationContext *ctx);
  ...
  public:
    KingbaseSqlParser::ExpressionContext *fromExpr = nullptr;;
    KingbaseSqlParser::ExpressionContext *toExpr = nullptr;;
    antlr4::Token *action_type = nullptr;;
    KingbaseSqlParser::ExpressionContext *action_expr = nullptr;;
  ...
  public:
    ...
    std::vector<Window_partContext *> window_part();
    Window_partContext* window_part(size_t i);
    std::vector<antlr4::tree::TerminalNode *> COMMA();
    antlr4::tree::TerminalNode* COMMA(size_t i);
  ...
  class  Window_partContext : public antlr4::ParserRuleContext {
  public:
    Window_partContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    Regular_idContext *regular_id();
    antlr4::tree::TerminalNode *AS();
    antlr4::tree::TerminalNode *LEFT_PAREN();
  ...
  Window_partContext* window_part();
  ...
  class  Frame_partContext : public antlr4::ParserRuleContext {
  public:
    Frame_partContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<Frame_start_or_endContext *> frame_start_or_end();
    Frame_start_or_endContext* frame_start_or_end(size_t i);
    antlr4::tree::TerminalNode *BETWEEN();
    antlr4::tree::TerminalNode *AND();
  ...
  class  Frame_start_or_endContext : public antlr4::ParserRuleContext {
  public:
    Frame_start_or_endContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  Frame_start_or_endContext* frame_start_or_end();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    Get_arguments_commandContext *get_arguments_command();
    Set_arguments_commandContext *set_arguments_command();
  ...
  class  Get_arguments_commandContext : public antlr4::ParserRuleContext {
  public:
    Get_arguments_commandContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *SHOW();
    IdentifierContext *identifier();
    antlr4::tree::TerminalNode *ALL();
  ...
  class  Set_arguments_commandContext : public antlr4::ParserRuleContext {
  public:
    Set_arguments_commandContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *SET();
    Regular_idContext *regular_id();
    antlr4::tree::TerminalNode *TO();
  ...
  class  Tablename_listContext : public antlr4::ParserRuleContext {
  public:
    Tablename_listContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<Container_tableview_nameContext *> container_tableview_name();
    Container_tableview_nameContext* container_tableview_name(size_t i);
    std::vector<antlr4::tree::TerminalNode *> COMMA();
    antlr4::tree::TerminalNode* COMMA(size_t i);
  ...
  class  Column_privilegeContext : public antlr4::ParserRuleContext {
  public:
    Column_privilegeContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *SELECT();
    antlr4::tree::TerminalNode *INSERT();
    antlr4::tree::TerminalNode *UPDATE();
