...
// Generated from /home/jona/myGit/myCode_repository/antlr4_cpp/replace_column/KingbaseSqlLexer.g4 by ANTLR 4.7.1
...
class  KingbaseSqlLexer : public KingbaseSqlBaseLexer {
public:
  enum {
  ...
  KingbaseSqlLexer(antlr4::CharStream *input);
  ~KingbaseSqlLexer();
...
private:
  ...
  bool REMARK_COMMENTSempred(antlr4::RuleContext *_localctx, size_t predicateIndex);
  bool PROMPT_MESSAGESempred(antlr4::RuleContext *_localctx, size_t predicateIndex);
  bool START_CMDSempred(antlr4::RuleContext *_localctx, size_t predicateIndex);
