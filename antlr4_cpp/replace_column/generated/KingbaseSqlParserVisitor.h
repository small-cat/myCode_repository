...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitSelected_list_element_asterisk(KingbaseSqlParser::Selected_list_element_asteriskContext *context) = 0;

    virtual antlrcpp::Any visitSelected_list_element_column(KingbaseSqlParser::Selected_list_element_columnContext *context) = 0;
    ...
    virtual antlrcpp::Any visitLock_table_statement(KingbaseSqlParser::Lock_table_statementContext *context) = 0;

    virtual antlrcpp::Any visitWait_nowait_part(KingbaseSqlParser::Wait_nowait_partContext *context) = 0;

    virtual antlrcpp::Any visitTruncate_statement(KingbaseSqlParser::Truncate_statementContext *context) = 0;

    virtual antlrcpp::Any visitLock_table_element(KingbaseSqlParser::Lock_table_elementContext *context) = 0;
    ...
    virtual antlrcpp::Any visitConcat_bar_bar(KingbaseSqlParser::Concat_bar_barContext *context) = 0;

    virtual antlrcpp::Any visitConcat_plus_minus(KingbaseSqlParser::Concat_plus_minusContext *context) = 0;

    virtual antlrcpp::Any visitConcat_mul_div(KingbaseSqlParser::Concat_mul_divContext *context) = 0;

    virtual antlrcpp::Any visitConcat_model_expr(KingbaseSqlParser::Concat_model_exprContext *context) = 0;
    ...
    virtual antlrcpp::Any visitWindow_clause(KingbaseSqlParser::Window_clauseContext *context) = 0;

    virtual antlrcpp::Any visitWindow_part(KingbaseSqlParser::Window_partContext *context) = 0;

    virtual antlrcpp::Any visitWindow_definition(KingbaseSqlParser::Window_definitionContext *context) = 0;

    virtual antlrcpp::Any visitFrame_clause(KingbaseSqlParser::Frame_clauseContext *context) = 0;

    virtual antlrcpp::Any visitFrame_part(KingbaseSqlParser::Frame_partContext *context) = 0;

    virtual antlrcpp::Any visitFrame_start_or_end(KingbaseSqlParser::Frame_start_or_endContext *context) = 0;
    ...
    virtual antlrcpp::Any visitCost_matrix_clause(KingbaseSqlParser::Cost_matrix_clauseContext *context) = 0;
