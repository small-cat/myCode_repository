...
java -Xmx500M -cp /home/jona/software/antlr4/antlr-4.7.1-complete.jar org.antlr.v4.Tool -Dlanguage=Cpp -listener -visitor -o generated/ -package oracle PlSqlLexer.g4 PlSqlParser.g4

sed -i 's/;;/;/g' generated/PlSqlParser.h
