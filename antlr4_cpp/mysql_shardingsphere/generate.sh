...
java -Xmx500M -cp /home/jona/software/antlr4/antlr-4.7.1-complete.jar org.antlr.v4.Tool -Dlanguage=Cpp -listener -visitor -o generated/ MySQLStatementLexer.g4 MySQLStatementParser.g4
