...
public:
  ...
  enum {
    ...
    RuleSql_statement = 178, RuleCursor_manipulation_statements = 179, RuleClose_statement = 180, 
    RuleOpen_statement = 181, RuleFetch_statement = 182, RuleDirection = 183, 
    RuleCount = 184, RuleMove_statement = 185, RuleTransaction_control_statements = 186, 
    RuleTransaction_command = 187, RuleLock_mode = 188, RuleSavepoint_command = 189, 
    RuleExplain_statement = 190, RuleExplain_elements = 191, RuleExplain_element = 192, 
    RuleError_logging_into_part = 193, RuleError_logging_reject_part = 194, 
    RuleSql_plus_command = 195, RuleGet_arguments_command = 196, RuleSet_arguments_command = 197, 
    RuleCost_class_name = 198, RuleSavepoint_name = 199, RuleRollback_segment_name = 200, 
    RuleTable_var_name = 201, RuleSchema_name = 202, RuleRoutine_name = 203, 
    RuleImplementation_type_name = 204, RuleParameter_name = 205, RuleReference_model_name = 206, 
    RuleMain_model_name = 207, RuleContainer_tableview_name = 208, RuleGrantee_name = 209, 
    RuleRole_name = 210, RuleType_name = 211, RuleSequence_name = 212, RuleException_name = 213, 
    RuleFunction_name = 214, RuleProcedure_name = 215, RuleTrigger_name = 216, 
    RuleVariable_name = 217, RuleIndex_name = 218, RuleCursor_name = 219, 
    RuleRecord_name = 220, RuleCollection_name = 221, RuleChar_set_name = 222, 
    RuleSynonym_name = 223, RuleSchema_object_name = 224, RuleDir_object_name = 225, 
    RuleUser_object_name = 226, RuleGrant_object_name = 227, RuleTablename_list = 228, 
    RuleObject_privilege = 229, RuleColumn_privilege = 230, RuleSystem_privilege = 231, 
    RuleData_manipulation_language_statements = 232, RuleMerge_statement = 233, 
    RuleMerge_update_clause = 234, RuleMerge_element = 235, RuleMerge_update_delete_part = 236, 
    RuleMerge_insert_clause = 237, RuleSelected_tableview = 238, RuleTruncate_statement = 239, 
    RuleSelect_statement = 240, RuleWith_clause = 241, RuleWith_query = 242, 
    RuleSubquery = 243, RuleSubquery_basic_elements = 244, RuleSubquery_operation_part = 245, 
    RuleDml_table_expression_clause = 246, RuleTable_collection_expression = 247, 
    RuleSubquery_restriction_clause = 248, RuleSample_clause = 249, RuleSeed_part = 250, 
    RuleQuery_block = 251, RuleTop_clause = 252, RuleStart_value = 253, 
    RuleLine_count = 254, RuleSelected_list = 255, RuleSelected_list_element = 256, 
    RuleFrom_clause = 257, RuleTable_ref_list = 258, RuleTable_ref = 259, 
    RuleTable_ref_aux = 260, RuleTable_ref_aux_internal = 261, RuleWhere_clause = 262, 
    RuleJoin_clause = 263, RuleJoin_on_part = 264, RuleJoin_using_part = 265, 
    RuleOuter_join_type = 266, RuleQuery_partition_clause = 267, RulePivot_clause = 268, 
    RulePivot_element = 269, RuleAggregate_function_name = 270, RulePivot_for_clause = 271, 
    RulePivot_in_clause = 272, RulePivot_in_clause_element = 273, RulePivot_in_clause_elements = 274, 
    RuleUnpivot_clause = 275, RuleUnpivot_in_clause = 276, RuleUnpivot_in_elements = 277, 
    RuleHierarchical_query_clause = 278, RuleStart_part = 279, RuleGroup_by_clause = 280, 
    RuleGroup_by_elements = 281, RuleRollup_cube_expression = 282, RuleEmpty_expression = 283, 
    RuleGrouping_sets_expression = 284, RuleHaving_clause = 285, RuleCell_assignment = 286, 
    RuleUntil_part = 287, RuleOrder_by_clause = 288, RuleOrder_by_elements = 289, 
    RuleLimit_clause = 290, RuleOffset_clause = 291, RuleFetch_clause = 292, 
    RuleFor_update_clause = 293, RuleFor_update_of_part = 294, RuleFor_update_options = 295, 
    RuleKeep_clause = 296, RuleFunction_argument = 297, RuleFunction_argument_analytic = 298, 
    RuleFunction_argument_modeling = 299, RuleRespect_or_ignore_nulls = 300, 
    RuleArgument = 301, RuleDatatype = 302, RulePrecision_part = 303, RuleNative_datatype_element = 304, 
    RuleUpdate_statement = 305, RuleUpdate_set_clause = 306, RuleColumn_based_update_set_clause = 307, 
    RuleDelete_statement = 308, RuleGeneral_table_ref = 309, RuleStatic_returning_clause = 310, 
    RuleInsert_statement = 311, RuleSingle_table_insert = 312, RuleMulti_table_insert = 313, 
    RuleMulti_table_element = 314, RuleConditional_insert_clause = 315, 
    RuleConditional_insert_when_part = 316, RuleConditional_insert_else_part = 317, 
    RuleInsert_into_clause = 318, RuleValues_clause = 319, RuleCopy_statement = 320, 
    RuleCondition = 321, RuleExpressions = 322, RuleExpression = 323, RuleCursor_expression = 324, 
    RuleLogical_expression = 325, RuleMultiset_expression = 326, RuleRelational_expression = 327, 
    RuleCompound_expression = 328, RuleRelational_operator = 329, RuleIn_elements = 330, 
    RuleBetween_elements = 331, RuleConcatenation = 332, RuleInterval_expression = 333, 
    RuleModel_expression = 334, RuleModel_expression_element = 335, RuleSingle_column_for_loop = 336, 
    RuleMulti_column_for_loop = 337, RuleUnary_expression = 338, RuleCase_statement = 339, 
    RuleSimple_case_statement = 340, RuleSimple_case_when_part = 341, RuleSearched_case_statement = 342, 
    RuleSearched_case_when_part = 343, RuleCase_else_part = 344, RuleAtom = 345, 
    RuleQuantified_expression = 346, RuleString_function = 347, RuleStandard_function = 348, 
    RuleNumeric_function_wrapper = 349, RuleNumeric_function = 350, RuleOther_function = 351, 
    RuleOver_clause_keyword = 352, RuleWithin_or_over_clause_keyword = 353, 
    RuleStandard_prediction_function_keyword = 354, RuleOver_clause = 355, 
    RuleWindowing_clause = 356, RuleWindowing_type = 357, RuleWindowing_elements = 358, 
    RuleCollect_order_by_part = 359, RuleWithin_or_over_part = 360, RuleXml_passing_clause = 361, 
    RuleXml_attributes_clause = 362, RuleXml_namespaces_clause = 363, RuleXml_table_column = 364, 
    RuleXml_general_default_part = 365, RuleXml_multiuse_expression_element = 366, 
    RuleXmlroot_param_version_part = 367, RuleXmlroot_param_standalone_part = 368, 
    RuleXmlserialize_param_enconding_part = 369, RuleXmlserialize_param_version_part = 370, 
    RuleXmlserialize_param_ident_part = 371, RuleBind_variable = 372, RuleGeneral_element = 373, 
    RuleGeneral_element_part = 374, RuleTable_element = 375, RuleTableview_name = 376, 
    RuleColumn_name = 377, RuleTable_name = 378, RuleLink_name = 379, RuleColumn_alias = 380, 
    RuleTable_alias = 381, RuleXml_column_name = 382, RuleParen_column_list = 383, 
    RuleColumn_list = 384, RuleWith_query_name = 385, RuleConstraint_name = 386, 
    RuleLabel_name = 387, RulePartition_extension_clause = 388, RuleConstant = 389, 
    RuleNumeric = 390, RuleNumeric_negative = 391, RuleQuoted_string = 392, 
    RuleIdentifier = 393, RuleId_expression = 394, RuleOuter_join_sign = 395, 
    RuleRegular_id = 396, RuleNon_reserved_keywords_in_12c = 397, RuleNon_reserved_keywords_pre12c = 398
  };
