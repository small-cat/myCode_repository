...
public:
  ...
  virtual antlrcpp::Any visitSelected_list_element(KingbaseSqlParser::Selected_list_elementContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitConcatenation(KingbaseSqlParser::ConcatenationContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitWindowing_clause(KingbaseSqlParser::Windowing_clauseContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitWindowing_type(KingbaseSqlParser::Windowing_typeContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitWindowing_elements(KingbaseSqlParser::Windowing_elementsContext *ctx) override {
    return visitChildren(ctx);
  }
